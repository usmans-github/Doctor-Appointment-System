...
const Login = () => {
  ...
  const {   setuser_token } = useContext(AppContext)
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    name="email"
                    id="email"
                    className="bg-gray-50 border border-gray-300 text-gray-900 rounded-[1rem] focus:ring-indigo-600 focus:border-indigo-500 block w-full p-2.5 "
                ...
                <div>
                  ...
                  <input
                    ...
                    id="password"
                    placeholder="••••••••"
                    className="bg-gray-50 border border-gray-300 text-gray-900 rounded-[1rem] focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required=""
                  />
                </div>
