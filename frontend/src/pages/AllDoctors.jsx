  ...
  return (
       <section className="mt-16 py-16 bg-[#f0f0f0] border rounded-t-[2.5rem] rounded-b-[2.5rem] px-4 sm:px-8 md:px-16">
         <div className="mb-12 flex flex-col justify-center items-center">
           ...
           <span className="text-xl sm:text-2xl font-semibold text-black text-center max-w-3xl">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
           {doctors.map((doctor, index) => (
             <div
               key={index}
               className=" group cursor-pointer w-full max-w-sm mx-auto border-[1px] border-indigo-500 rounded-[2rem] overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300"
             >
               {/* Image Container */}
               <div className="p-3 relative h-64 sm:h-72 md:h-80">
                 <img
