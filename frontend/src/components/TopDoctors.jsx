...
const TopDoctors = () => {
  ...
  return (
    <section className="mt-16 py-16 bg-[#f0f0f0] border rounded-t-[2.5rem] md:px-16 rounded-b-[2.5rem]">
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center w-full">
            ...
            <div className="below p-6">
              <div className="flex justify-between items-center">
                ...
                <p className="flex justify-center gap-1 items-center text-md text-white mb-2">
                  <Sparkle size={16} className="group-hover:text-black transition-all" />
