...
const TopDoctors = () => {
  ...
  return (
    <section className="mt-16 py-16 bg-[#f0f0f0] border rounded-t-[2.5rem]  md:px-16  rounded-b-[2.5rem]">
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-2 mt-4 gap-8 justify-center w-full ">
        {doctors.map((doctor, index) => (
          ...
          >
            <div className="relative h-[35vh] md:h-[40vh] ">
              ...
              />
              <div className="absolute top-2 left-2 group-hover:bg-black bg-indigo-500 text-white
            ...
            <div className="below p-6">
              ...
              <Link to="/register">
                <button className=" font-semibold gap-2 group-hover:gap-4 transition-all text-lg flex
                 justify-center items-center text-center w-full py-3 bg-[#f0f0f0] rounded-[1.5rem] self-center ">
