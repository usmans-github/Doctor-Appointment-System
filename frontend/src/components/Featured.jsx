      ...
      <div className="grid grid-cols-2">
        ...
        <div className="p-6 flex items-center">
          <img
            src="doctors.png"
            alt="doctors"
            className="lg:h-[45vh] md:h-[50vh] sm:h-[30vh] md:mx-8 group-hover:scale-110 transition-all 
        ...
        <div className="flex flex-col items-start text-sm gap-0 md:gap-4 lg:h-[60vh] md:h-[50vh] justify-center">
          <p className="md:text-lg font-semibold">Sehat X</p>
          <h1
            className="lg:text-5xl md:text-3xl px-2 text-start font-extrabold group-hover:text-zinc-900
              text-indigo-500 mt-2 "
          >
            Qualified and Experts Doctors that meet your needs
          </h1>
          <div
            className="flex justify-center items-center group-hover:text-zinc-900 group-hover:gap-2 transition-all
